...
//  ИмяТабличногоДокумента - Строка - имя реквизита формы типа ТабличныйДокумент, показатели которго рассчитываются.
...
Функция ФорматРедактированияПоказателя(ЗначениеПоказателя)
	...
	ПредставлениеПоказателя = Формат(ЗначениеПоказателя, СтрШаблон(ШаблонФорматаРедактирования, РазрядностьДробнойЧасти));
