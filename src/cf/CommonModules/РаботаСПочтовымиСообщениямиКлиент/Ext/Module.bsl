...
Процедура ПерейтиКДокументацииПоВводуУчетнойЗаписиЭлектроннойПочты() Экспорт
	...
	ФайловаяСистемаКлиент.ОткрытьНавигационнуюСсылку("https://its.1c.ru/db/translate?db=bsp303doc&path=src/5.48 работа с почтовыми сообщениями.htm&anchor=issogl1_ввод_учетной_записи_электронной_почты");
