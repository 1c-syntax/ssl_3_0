...
&НаСервереБезКонтекста
Функция СостояниеДлительнойОперации(Знач ИдентификаторОперации, УзелОбмена, ПолучитьПарольИзСеансовыхДанных)
...
Процедура ОбработчикОжиданияДлительнойОперации()
	...
	Если ОбменЧерезВебСервис Тогда
		...
		СостояниеОперации = СостояниеДлительнойОперации(ИдентификаторОперации, Объект.УзелИнформационнойБазы, ПолучитьПарольИзСеансовыхДанных);
	Иначе
